...
func checkListLen[TElem any](t *testing.T, l *LinkedList[TElem], len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers[TElem any](t *testing.T, l *LinkedList[TElem], es []*Element[TElem]) {
	root := &l.root
...
func checkList[TElem comparable](t *testing.T, l *LinkedList[TElem], es []interface{}) {
	if !checkListLen(t, l, len(es)) {
		return
	}
